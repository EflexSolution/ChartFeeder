...
#[derive(Debug)]
pub struct ChartFeederProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChartFeederProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChartFeeder processing");
    
    let mut processor = ChartFeederProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChartFeederProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChartFeederProcessor::new(false);
